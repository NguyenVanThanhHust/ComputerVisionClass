...
${CUDA_ROOT}/bin/nvcc -std=c++11 -c -o tf_grouping_g.cu.o tf_grouping_g.cu -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
...
# g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I ${TF_ROOT}/include -I ${CUDA_ROOT}/include -lcudart -L ${CUDA_ROOT}/lib64/ -O2 
